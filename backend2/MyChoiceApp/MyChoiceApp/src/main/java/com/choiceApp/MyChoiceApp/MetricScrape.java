...
//import io.prometheus.metrics.config.*;
...
//@RestController
//public class MetricScrape implements WebMvcConfigurer {
//
//    private final Map<Integer, String> items = new HashMap<>();
//    private final PrometheusRegistry prometheusMeterRegistry;
//
//    public MetricScrape(PrometheusRegistry prometheusMeterRegistry) {
